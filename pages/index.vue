...
<template>
  <div v-motion-slide-visible-right>
    ...
    <div class="py-16 text-left">
      ...
      <a
        download
        href="/[CV]_Nguyen_Duc_Anh.pdf"
        class="text-[#1d4ed8] cursor-pointer flex gap-3 mt-6 text-sm"
      >
        Get My Resume
        <object
          data="/next.svg"
      ...
      <NuxtLink to="/work">
        <div class="text-[#1d4ed8] cursor-pointer flex gap-3 mt-4 text-sm">
          Learn More
          <object
            data="/next.svg"
            type="image/svg+xml"
    ...
    <div class="py-6">
      ...
      <div class="flex flex-col gap-10">
        ...
        <LazyWorkCard
          name="Funplay68's Game"
          timeline="2024"
          role="Developer"
          img="funplay-68.png"
          link="/work/funplay68-game"
          color-hex="#fbbf24"
        >
          <template #stack
